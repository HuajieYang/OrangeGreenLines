...
ggplot(ridership_w_experimental_summary2, aes(date, ONES_SUM)) + geom_smooth() + 
  geom_point() + ggtitle("average total weekday boardings at all bus stops and \n rail stations within the experimental corridor")
...
ggplot(ridership_w_experimental_summary3, aes(date, ONES_SUM)) + geom_smooth() + geom_point()  + ylim (4000, 7000) + 
    ggtitle("average total weekday boardings at MAX Orange Line \n stations within the experimental corridor")
